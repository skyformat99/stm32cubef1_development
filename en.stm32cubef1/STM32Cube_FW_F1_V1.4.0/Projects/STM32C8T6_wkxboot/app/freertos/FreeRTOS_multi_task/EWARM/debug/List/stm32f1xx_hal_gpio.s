...
//    Endian       =  little
//    Source file  =  
//        D:\development\stm32\src_code\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_gpio.c
//    Command line =  
//        -f C:\Users\wkxbo\AppData\Local\Temp\EWCFD3.tmp
//        (D:\development\stm32\src_code\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_gpio.c
...
//    Locale       =  C
//    List file    =  
//        D:\development\stm32\src_code\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Projects\STM32C8T6_wkxboot\app\freertos\FreeRTOS_multi_task\EWARM\debug\List\stm32f1xx_hal_gpio.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  309         __HAL_RCC_AFIO_CLK_ENABLE();
        LDR.N    R0,??DataTable2_6  ;; 0x40021018
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
...
//  319           SET_BIT(EXTI->IMR, iocurrent); 
        LDR.N    R0,??DataTable2_12  ;; 0x40010400
        LDR      R0,[R0, #+0]
        ORRS     R0,R5,R0
        LDR.W    R12,??DataTable2_12  ;; 0x40010400
        STR      R0,[R12, #+0]
        B.N      ??HAL_GPIO_Init_24
//  320         } 
//  321         else
//  322         {
...
//  329           SET_BIT(EXTI->EMR, iocurrent); 
        LDR.N    R0,??DataTable2_13  ;; 0x40010404
        LDR      R0,[R0, #+0]
        ORRS     R0,R5,R0
        LDR.W    R12,??DataTable2_13  ;; 0x40010404
        STR      R0,[R12, #+0]
...
//  339           SET_BIT(EXTI->RTSR, iocurrent); 
        LDR.N    R0,??DataTable2_14  ;; 0x40010408
        LDR      R0,[R0, #+0]
        ORRS     R0,R5,R0
        LDR.W    R12,??DataTable2_14  ;; 0x40010408
        STR      R0,[R12, #+0]
...
//  349           SET_BIT(EXTI->FTSR, iocurrent); 
        LDR.N    R0,??DataTable2_15  ;; 0x4001040c
        LDR      R0,[R0, #+0]
        ORRS     R0,R5,R0
        LDR.W    R12,??DataTable2_15  ;; 0x4001040c
        STR      R0,[R12, #+0]
        B.N      ??HAL_GPIO_Init_2
//  350         } 
//  351         else
...
//  410         CLEAR_BIT(EXTI->IMR, (uint32_t)iocurrent);
        LDR.N    R1,??DataTable2_12  ;; 0x40010400
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR.W    R12,??DataTable2_12  ;; 0x40010400
        STR      R1,[R12, #+0]
//  411         CLEAR_BIT(EXTI->EMR, (uint32_t)iocurrent);
        LDR.N    R1,??DataTable2_13  ;; 0x40010404
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR.W    R12,??DataTable2_13  ;; 0x40010404
        STR      R1,[R12, #+0]
...
//  414         CLEAR_BIT(EXTI->RTSR, (uint32_t)iocurrent);
        LDR.N    R1,??DataTable2_14  ;; 0x40010408
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR.W    R12,??DataTable2_14  ;; 0x40010408
        STR      R1,[R12, #+0]
//  415         CLEAR_BIT(EXTI->FTSR, (uint32_t)iocurrent);
        LDR.N    R1,??DataTable2_15  ;; 0x4001040c
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR.W    R12,??DataTable2_15  ;; 0x4001040c
        STR      R1,[R12, #+0]
...
//  558   if(__HAL_GPIO_EXTI_GET_IT(GPIO_Pin) != RESET) 
        LDR.N    R0,??DataTable2_16  ;; 0x40010414
        LDR      R0,[R0, #+0]
