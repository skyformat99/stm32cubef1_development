  ...
  for (position = 0; position < ((uint32_t)16); position++)
  {
    ...
    if (iocurrent == ioposition)
    {
      ...
      if((GPIO_Init->Mode & ((uint32_t)0x10000000)) == ((uint32_t)0x10000000)) 
      {
        ...
        ((temp) |= (((((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))))? 3U :4U)) << (4 * (position & 0x03))));
...
{ 
  ...
  while ((GPIO_Pin >> position) != 0)
  {
    ...
    if (iocurrent)
    {
      ...
      if(tmp == ((((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))))? 3U :4U) << (4 * (position & 0x03))))
      {
        tmp = ((uint32_t)0x0F) << (4 * (position & 0x03));
