...
#line 135 "..\\..\\..\\..\\Drivers\\STM32F1xx_HAL_Driver\\Src\\stm32f1xx_hal_irda.c"
...
HAL_StatusTypeDef HAL_IRDA_Init(IRDA_HandleTypeDef *hirda)
{
  ...
  ((hirda->Instance ->CR2) &= ~(((0x1U << (14U)) | (0x3U << (12U)) | (0x1U << (11U)))));
  ((hirda->Instance ->CR3) &= ~(((0x1U << (5U)) | (0x1U << (3U)))));
  
   
  ((((hirda)->Instance ->CR1) |= ((0x1U << (13U)))));
  
   
  (((hirda->Instance ->GTPR)) = ((((((hirda->Instance ->GTPR))) & (~((0xFFU << (0U))))) | (hirda->Init . Prescaler))));
  
   
  (((hirda->Instance ->CR3)) = ((((((hirda->Instance ->CR3))) & (~((0x1U << (2U))))) | (hirda->Init . IrDAMode))));
  
   
  ((hirda->Instance ->CR3) |= ((0x1U << (1U))));
  
   
  hirda->ErrorCode = ((uint32_t)0x00);
...
HAL_StatusTypeDef HAL_IRDA_DeInit(IRDA_HandleTypeDef *hirda)
{
  ...
  do{ (hirda)->Lock = HAL_UNLOCKED; }while (0);
...
HAL_StatusTypeDef HAL_IRDA_Transmit(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_READY) || (tmp_state == HAL_IRDA_STATE_BUSY_RX))
  {
    ...
    do{ if((hirda)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hirda)->Lock = HAL_LOCKED; } }while (0);
    ...
    {
      if(hirda->Init.WordLength == ((uint32_t)(0x1U << (12U))))
      {
        if(IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1U << (7U))), RESET, Timeout) != HAL_OK)
        {
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t*) pData;
        ((hirda->Instance ->DR) = ((*tmp & (uint16_t)0x01FF)));
        if(hirda->Init.Parity == ((uint32_t)0x00000000))
        {
          pData +=2;
        }
        else
    ...
    if(IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1U << (6U))), RESET, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }
...
HAL_StatusTypeDef HAL_IRDA_Receive(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_READY) || (tmp_state == HAL_IRDA_STATE_BUSY_TX))
  {
    ...
    while(hirda->RxXferCount > 0)
    {
      if(hirda->Init.WordLength == ((uint32_t)(0x1U << (12U))))
      {
        if(IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1U << (5U))), RESET, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t*) pData ;
      ...
      else
      {
        ...
        if(hirda->Init.Parity == ((uint32_t)0x00000000))
        {
          *pData++ = (uint8_t)(hirda->Instance->DR & (uint8_t)0xFF);
        }
        else
        {
          *pData++ = (uint8_t)(hirda->Instance->DR & (uint8_t)0x7F);
        }
      }
      hirda->RxXferCount--;
    }
...
HAL_StatusTypeDef HAL_IRDA_Transmit_IT(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_READY) || (tmp_state == HAL_IRDA_STATE_BUSY_RX))
  {
    ...
    ((((((uint32_t)(1 << 28 | (0x1U << (7U))))) >> 28) == 1)? ((hirda)->Instance ->CR1 |= ((((uint32_t)(1 << 28 | (0x1U << (7U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): (((((uint32_t)(1 << 28 | (0x1U << (7U))))) >> 28) == 2)? ((hirda)->Instance ->CR2 |= ((((uint32_t)(1 << 28 | (0x1U << (7U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): ((hirda)->Instance ->CR3 |= ((((uint32_t)(1 << 28 | (0x1U << (7U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))));
...
HAL_StatusTypeDef HAL_IRDA_Receive_IT(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_READY) || (tmp_state == HAL_IRDA_STATE_BUSY_TX))
  {
    ...
    ((((((uint32_t)(1 << 28 | (0x1U << (5U))))) >> 28) == 1)? ((hirda)->Instance ->CR1 |= ((((uint32_t)(1 << 28 | (0x1U << (5U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): (((((uint32_t)(1 << 28 | (0x1U << (5U))))) >> 28) == 2)? ((hirda)->Instance ->CR2 |= ((((uint32_t)(1 << 28 | (0x1U << (5U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): ((hirda)->Instance ->CR3 |= ((((uint32_t)(1 << 28 | (0x1U << (5U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )))); 

     
    ((((((uint32_t)(1 << 28 | (0x1U << (8U))))) >> 28) == 1)? ((hirda)->Instance ->CR1 |= ((((uint32_t)(1 << 28 | (0x1U << (8U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): (((((uint32_t)(1 << 28 | (0x1U << (8U))))) >> 28) == 2)? ((hirda)->Instance ->CR2 |= ((((uint32_t)(1 << 28 | (0x1U << (8U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): ((hirda)->Instance ->CR3 |= ((((uint32_t)(1 << 28 | (0x1U << (8U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))));

     
    ((((((uint32_t)(3 << 28 | (0x1U << (0U))))) >> 28) == 1)? ((hirda)->Instance ->CR1 |= ((((uint32_t)(3 << 28 | (0x1U << (0U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): (((((uint32_t)(3 << 28 | (0x1U << (0U))))) >> 28) == 2)? ((hirda)->Instance ->CR2 |= ((((uint32_t)(3 << 28 | (0x1U << (0U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): ((hirda)->Instance ->CR3 |= ((((uint32_t)(3 << 28 | (0x1U << (0U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))));
...
HAL_StatusTypeDef HAL_IRDA_Transmit_DMA(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_READY) || (tmp_state == HAL_IRDA_STATE_BUSY_RX))
  {
    ...
    ((hirda)->Instance ->SR = ~(((uint32_t)(0x1U << (6U)))));

    
 
    ((hirda->Instance ->CR3) |= ((0x1U << (7U))));
...
HAL_StatusTypeDef HAL_IRDA_DMAPause(IRDA_HandleTypeDef *hirda)
{
  ...
  else if (hirda->State == HAL_IRDA_STATE_BUSY_TX_RX)
  {
    ...
    ((hirda->Instance ->CR3) &= ~(((0x1U << (7U)) | (0x1U << (6U)))));
  }
  else
  {
...
HAL_StatusTypeDef HAL_IRDA_DMAResume(IRDA_HandleTypeDef *hirda)
{
  ...
  else if(hirda->State == HAL_IRDA_STATE_BUSY_RX)
  {
    ...
    do{ volatile uint32_t tmpreg; tmpreg = (hirda)->Instance ->SR; tmpreg = (hirda)->Instance ->DR; ((void)(tmpreg)); }while(0);
...
void HAL_IRDA_IRQHandler(IRDA_HandleTypeDef *hirda)
{
  ...
  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (0U))))) == (((uint32_t)(0x1U << (0U)))));
  tmp_it_source = (((((((uint32_t)(1 << 28 | (0x1U << (8U))))) >> 28) == 1)? (hirda)->Instance ->CR1:((((((uint32_t)(1 << 28 | (0x1U << (8U))))) >> 28) == 2)? (hirda)->Instance ->CR2 : (hirda)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(1 << 28 | (0x1U << (8U)))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )));
   
  if((tmp_flag != RESET) && (tmp_it_source != RESET))
  {
    hirda->ErrorCode |= ((uint32_t)0x01);
  }

  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (1U))))) == (((uint32_t)(0x1U << (1U)))));
  tmp_it_source = (((((((uint32_t)(3 << 28 | (0x1U << (0U))))) >> 28) == 1)? (hirda)->Instance ->CR1:((((((uint32_t)(3 << 28 | (0x1U << (0U))))) >> 28) == 2)? (hirda)->Instance ->CR2 : (hirda)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(3 << 28 | (0x1U << (0U)))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )));
   
  if((tmp_flag != RESET) && (tmp_it_source != RESET))
  {
    hirda->ErrorCode |= ((uint32_t)0x04);
  }

  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (2U))))) == (((uint32_t)(0x1U << (2U)))));
   
  if((tmp_flag != RESET) && (tmp_it_source != RESET))
  {
    hirda->ErrorCode |= ((uint32_t)0x02);
  }

  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (3U))))) == (((uint32_t)(0x1U << (3U)))));
   
  if((tmp_flag != RESET) && (tmp_it_source != RESET))
  {
    hirda->ErrorCode |= ((uint32_t)0x08);
  }

   
  if(hirda->ErrorCode != ((uint32_t)0x00))
  {
  ...
  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (5U))))) == (((uint32_t)(0x1U << (5U)))));
  tmp_it_source = (((((((uint32_t)(1 << 28 | (0x1U << (5U))))) >> 28) == 1)? (hirda)->Instance ->CR1:((((((uint32_t)(1 << 28 | (0x1U << (5U))))) >> 28) == 2)? (hirda)->Instance ->CR2 : (hirda)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(1 << 28 | (0x1U << (5U)))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )));
  ...
  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (7U))))) == (((uint32_t)(0x1U << (7U)))));
  tmp_it_source = (((((((uint32_t)(1 << 28 | (0x1U << (7U))))) >> 28) == 1)? (hirda)->Instance ->CR1:((((((uint32_t)(1 << 28 | (0x1U << (7U))))) >> 28) == 2)? (hirda)->Instance ->CR2 : (hirda)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(1 << 28 | (0x1U << (7U)))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )));
  ...
  tmp_flag = (((hirda)->Instance ->SR & (((uint32_t)(0x1U << (6U))))) == (((uint32_t)(0x1U << (6U)))));
  tmp_it_source = (((((((uint32_t)(1 << 28 | (0x1U << (6U))))) >> 28) == 1)? (hirda)->Instance ->CR1:((((((uint32_t)(1 << 28 | (0x1U << (6U))))) >> 28) == 2)? (hirda)->Instance ->CR2 : (hirda)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(1 << 28 | (0x1U << (6U)))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) )));
...
static void IRDA_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ( (((hdma->Instance ->CCR) & ((0x1U << (5U)))) == RESET) )
  {
    ...
    ((((((uint32_t)(1 << 28 | (0x1U << (6U))))) >> 28) == 1)? ((hirda)->Instance ->CR1 |= ((((uint32_t)(1 << 28 | (0x1U << (6U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): (((((uint32_t)(1 << 28 | (0x1U << (6U))))) >> 28) == 2)? ((hirda)->Instance ->CR2 |= ((((uint32_t)(1 << 28 | (0x1U << (6U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))): ((hirda)->Instance ->CR3 |= ((((uint32_t)(1 << 28 | (0x1U << (6U))))) & ((uint32_t) (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)) | (0x1U << (4U)) | (0x1U << (6U)) | (0x1U << (10U)) | (0x1U << (0U)) ))));
  }
...
static HAL_StatusTypeDef IRDA_WaitOnFlagUntilTimeout(IRDA_HandleTypeDef *hirda, uint32_t Flag, FlagStatus Status, uint32_t Timeout)
{
  ...
  if(Status == RESET)
  {
    while((((hirda)->Instance ->SR & (Flag)) == (Flag)) == RESET)
    {
...
static HAL_StatusTypeDef IRDA_Transmit_IT(IRDA_HandleTypeDef *hirda)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_BUSY_TX) || (tmp_state == HAL_IRDA_STATE_BUSY_TX_RX))
  {
    ...
    {
      ((hirda->Instance ->DR) = ((uint8_t)(*hirda->pTxBuffPtr++ & (uint8_t)0xFF)));
    }
...
static HAL_StatusTypeDef IRDA_Receive_IT(IRDA_HandleTypeDef *hirda)
{
  ...
  if((tmp_state == HAL_IRDA_STATE_BUSY_RX) || (tmp_state == HAL_IRDA_STATE_BUSY_TX_RX))
  {
    ...
    else
    {
      if(hirda->Init.Parity == ((uint32_t)0x00000000))
      {
        *hirda->pRxBuffPtr++ = (uint8_t)(hirda->Instance->DR & (uint8_t)0xFF);
      }
      else
      {
        *hirda->pRxBuffPtr++ = (uint8_t)(hirda->Instance->DR & (uint8_t)0x7F);
      }
    }
...
static void IRDA_SetConfig(IRDA_HandleTypeDef *hirda)
{
  ...
  (((hirda->Instance ->CR1)) = ((((((hirda->Instance ->CR1))) & (~(((uint32_t)((0x1U << (12U)) | (0x1U << (10U)) | (0x1U << (9U)) | (0x1U << (3U)) | (0x1U << (2U))))))) | ((uint32_t)hirda->Init . WordLength | hirda->Init . Parity | hirda->Init . Mode))));


  
   
   
  ((hirda->Instance ->CR3) &= ~(((0x1U << (8U)) | (0x1U << (9U)))));
  
   
  if(hirda->Instance == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
  {
    hirda->Instance->BRR = (((((((((HAL_RCC_GetPCLK2Freq())))*25)/(4*(((hirda->Init . BaudRate)))))/100) << 4) + (((((((((HAL_RCC_GetPCLK2Freq())))*25)/(4*(((hirda->Init . BaudRate))))) - ((((((((HAL_RCC_GetPCLK2Freq()))))*25)/(4*((((hirda->Init . BaudRate))))))/100) * 100)) * 16 + 50) / 100) & 0xF0)) + (((((((((HAL_RCC_GetPCLK2Freq())))*25)/(4*(((hirda->Init . BaudRate))))) - ((((((((HAL_RCC_GetPCLK2Freq()))))*25)/(4*((((hirda->Init . BaudRate))))))/100) * 100)) * 16 + 50) / 100) & 0x0F));
  }
  else
  {
    hirda->Instance->BRR = (((((((((HAL_RCC_GetPCLK1Freq())))*25)/(4*(((hirda->Init . BaudRate)))))/100) << 4) + (((((((((HAL_RCC_GetPCLK1Freq())))*25)/(4*(((hirda->Init . BaudRate))))) - ((((((((HAL_RCC_GetPCLK1Freq()))))*25)/(4*((((hirda->Init . BaudRate))))))/100) * 100)) * 16 + 50) / 100) & 0xF0)) + (((((((((HAL_RCC_GetPCLK1Freq())))*25)/(4*(((hirda->Init . BaudRate))))) - ((((((((HAL_RCC_GetPCLK1Freq()))))*25)/(4*((((hirda->Init . BaudRate))))))/100) * 100)) * 16 + 50) / 100) & 0x0F));
  }
}
