...
//    Endian       =  little
//    Source file  =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_rcc_ex.c
//    Command line =  
//        -f C:\Users\wkxbo\AppData\Local\Temp\EW54E3.tmp
//        (D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_rcc_ex.c
...
//    Locale       =  C
//    List file    =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Projects\STM32F103ZET6_JJDK_ZK_01_V5\app\freertos\automatic_wine_machine\EWARM\DEBUG\List\stm32f1xx_hal_rcc_ex.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  135     __HAL_RCC_PWR_CLK_ENABLE();
        LDR.N    R0,??DataTable2  ;; 0x4002101c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x10000000
        LDR.N    R1,??DataTable2  ;; 0x4002101c
        STR      R0,[R1, #+0]
        LDR.N    R0,??DataTable2  ;; 0x4002101c
        LDR      R0,[R0, #+0]
...
//  138     SET_BIT(PWR->CR, PWR_CR_DBP);
        LDR.N    R0,??DataTable2_1  ;; 0x40007000
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x100
        LDR.N    R1,??DataTable2_1  ;; 0x40007000
        STR      R0,[R1, #+0]
//  139     
...
??HAL_RCCEx_PeriphCLKConfig_2:
        LDR.N    R0,??DataTable2_2  ;; 0x40021020
        LDR      R0,[R0, #+0]
        ANDS     R0,R0,#0x300
        MOVS     R4,R0
...
//  158       __HAL_RCC_BACKUPRESET_FORCE();
        ...
        MOV      R1,#+32768
        CLZ      R1,R1
        LDR.N    R2,??DataTable2_3  ;; 0x42420400
        ADDS     R2,R2,R1, LSL #+2
        STR      R0,[R2, #+0]
...
??HAL_RCCEx_PeriphCLKConfig_6:
        LDR.N    R0,??DataTable2_4  ;; 0x40021024
        LDR      R0,[R0, #+0]
...
//  189     __HAL_RCC_ADC_CONFIG(PeriphClkInit->AdcClockSelection);
        LDR.N    R0,??DataTable2_5  ;; 0x40021004
        LDR      R1,[R0, #+0]
        BICS     R1,R1,#0xC000
        LDR      R0,[R5, #+8]
        ORRS     R1,R0,R1
...
??HAL_RCCEx_PeriphCLKConfig_8:
        LDRB     R0,[R5, #+0]
        LSLS     R0,R0,#+27
        BPL.N    ??HAL_RCCEx_PeriphCLKConfig_9
//  276   {
...
//  303   srcclk = __HAL_RCC_GET_RTC_SOURCE();
        LDR.N    R2,??DataTable2_2  ;; 0x40021020
        LDR      R2,[R2, #+0]
        ANDS     R2,R2,#0x300
        MOVS     R1,R2
...
//  309   PeriphClkInit->AdcClockSelection = __HAL_RCC_GET_ADC_SOURCE();
        LDR.N    R2,??DataTable2_5  ;; 0x40021004
        LDR      R2,[R2, #+0]
        ANDS     R2,R2,#0xC000
        STR      R2,[R0, #+8]
//  310 
...
//  425       if (HAL_IS_BIT_SET(RCC->CR,RCC_CR_PLLON))
        LDR.N    R0,??DataTable2_8  ;; 0x40021000
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+7
...
??HAL_RCCEx_GetPeriphCLKFreq_7:
        LDR.N    R0,??DataTable2_10  ;; 0x3d0900
        MUL      R0,R0,R9
        MOV      R8,R0
//  470         }
//  471 
...
//  561       if (((temp_reg & RCC_BDCR_RTCSEL) == RCC_RTCCLKSOURCE_LSE) && (HAL_IS_BIT_SET(temp_reg, RCC_BDCR_LSERDY)))
        ...
        ANDS     R0,R0,R5
        CMP      R0,#+258
        BNE.N    ??HAL_RCCEx_GetPeriphCLKFreq_11
//  562       {
//  563         frequency = LSE_VALUE;
        MOV      R0,#+32768
        MOVS     R6,R0
        B.N      ??HAL_RCCEx_GetPeriphCLKFreq_12
//  564       }
...
??HAL_RCCEx_GetPeriphCLKFreq_11:
        ANDS     R0,R5,#0x300
        CMP      R0,#+512
        BNE.N    ??HAL_RCCEx_GetPeriphCLKFreq_13
        LDR.N    R0,??DataTable2_4  ;; 0x40021024
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+30
        BPL.N    ??HAL_RCCEx_GetPeriphCLKFreq_13
//  567       {
...
??HAL_RCCEx_GetPeriphCLKFreq_1:
        ...
        LDR.N    R1,??DataTable2_5  ;; 0x40021004
        LDR      R1,[R1, #+0]
        ANDS     R1,R1,#0xC000
        MOVS     R2,#+131072
        CLZ      R2,R2
