///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.1.13263/W32 for ARM      20/Apr/2017  15:44:02
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal.c
//    Command line =  
//        -f C:\Users\wkxbo\AppData\Local\Temp\EW4E17.tmp
//        (D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal.c
...
//    Locale       =  C
//    List file    =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Projects\STM32F103ZET6_JJDK_ZK_01_V5\app\freertos\automatic_wine_machine\EWARM\DEBUG\List\stm32f1xx_hal.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  167   __HAL_FLASH_PREFETCH_BUFFER_ENABLE();
        LDR.N    R0,??DataTable10  ;; 0x40022000
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x10
        LDR.N    R1,??DataTable10  ;; 0x40022000
        STR      R0,[R1, #+0]
//  168 #endif
...
//  193   __HAL_RCC_APB1_FORCE_RESET();
        MOVS     R0,#-1
        LDR.N    R1,??DataTable10_1  ;; 0x4002100c
        STR      R0,[R1, #+0]
//  194   __HAL_RCC_APB1_RELEASE_RESET();
        MOVS     R0,#+0
        LDR.N    R1,??DataTable10_2  ;; 0x40021010
        STR      R0,[R1, #+0]
//  195 
...
HAL_GetHalVersion:
        LDR.N    R0,??DataTable10_3  ;; 0x1000400
        BX       LR               ;; return
//  372 }
...
HAL_GetREVID:
        LDR.N    R0,??DataTable10_4  ;; 0xe0042000
        LDR      R0,[R0, #+0]
        MOVW     R1,#+65535
        CLZ      R1,R1
        LSRS     R0,R0,R1
...
HAL_DBGMCU_EnableDBGSleepMode:
        LDR.N    R0,??DataTable10_5  ;; 0xe0042004
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable10_5  ;; 0xe0042004
        STR      R0,[R1, #+0]
//  413 }
        BX       LR               ;; return
...
// 
// 210 bytes of CODE memory (+ 134 bytes shared)
