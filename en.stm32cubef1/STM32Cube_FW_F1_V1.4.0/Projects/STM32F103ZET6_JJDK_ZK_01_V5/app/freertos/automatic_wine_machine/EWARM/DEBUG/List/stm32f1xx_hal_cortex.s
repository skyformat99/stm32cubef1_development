...
//    Endian       =  little
//    Source file  =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_cortex.c
//    Command line =  
//        -f C:\Users\wkxbo\AppData\Local\Temp\EW4FFC.tmp
//        (D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_cortex.c
...
//    Locale       =  C
//    List file    =  
//        D:\development\stm32\src_code\stm32cubef1\en.stm32cubef1\STM32Cube_FW_F1_V1.4.0\Projects\STM32F103ZET6_JJDK_ZK_01_V5\app\freertos\automatic_wine_machine\EWARM\DEBUG\List\stm32f1xx_hal_cortex.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_SetPriority:
        ...
        LSLS     R2,R1,#+4
        LDR.N    R3,??DataTable12_7  ;; 0xe000ed18
        SXTB     R0,R0            ;; SignExt  R0,R0,#+24,#+24
        ANDS     R4,R0,#0xF
        ADD      R3,R3,R4
        STRB     R2,[R3, #-4]
...
??NVIC_SetPriority_0:
        LSLS     R2,R1,#+4
        LDR.N    R3,??DataTable12_8  ;; 0xe000e400
        SXTB     R0,R0            ;; SignExt  R0,R0,#+24,#+24
        STRB     R2,[R3, R0]
??NVIC_SetPriority_1:
        POP      {R4}
...
??NVIC_GetPriority_0:
        LDR.N    R1,??DataTable12_8  ;; 0xe000e400
        SXTB     R0,R0            ;; SignExt  R0,R0,#+24,#+24
        LDRB     R0,[R1, R0]
        LSRS     R0,R0,#+4
??NVIC_GetPriority_1:
...
??SysTick_Config_0:
        SUBS     R0,R4,#+1
        LDR.N    R1,??DataTable12_10  ;; 0xe000e014
        STR      R0,[R1, #+0]
        MOVS     R1,#+15
        MOVS     R0,#-1
        ...
        BL       NVIC_SetPriority
        MOVS     R0,#+0
        LDR.N    R1,??DataTable12_11  ;; 0xe000e018
        STR      R0,[R1, #+0]
        MOVS     R0,#+7
        LDR.N    R1,??DataTable12_12  ;; 0xe000e010
        STR      R0,[R1, #+0]
        MOVS     R0,#+0
??SysTick_Config_1:
        POP      {R4,PC}          ;; return
...
//  449     SysTick->CTRL |= SYSTICK_CLKSOURCE_HCLK;
        ...
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0x4
        LDR.N    R2,??DataTable12_12  ;; 0xe000e010
        STR      R1,[R2, #+0]
