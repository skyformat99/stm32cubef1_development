...
int main(void)
{
  ...
  UartHandle.Instance        = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800));

  UartHandle.Init.BaudRate   = 9600;
  UartHandle.Init.WordLength = ((uint32_t)0x00000000);
  UartHandle.Init.StopBits   = ((uint32_t)0x00000000);
  UartHandle.Init.Parity     = ((uint32_t)((0x1U << (10U)) | (0x1U << (9U))));
  UartHandle.Init.HwFlowCtl  = ((uint32_t)0x00000000);
  UartHandle.Init.Mode       = ((uint32_t)((0x1U << (3U)) |(0x1U << (2U))));
...
void SystemClock_Config(void)
{
  ...
  oscinitstruct.OscillatorType        = ((uint32_t)0x00000001);
  oscinitstruct.HSEState              = (0x1U << (16U));
  oscinitstruct.HSEPredivValue        = ((uint32_t)0x00000000);

  oscinitstruct.PLL.PLLState          = ((uint32_t)0x00000002);
  oscinitstruct.PLL.PLLSource         = (0x1U << (16U));
  oscinitstruct.PLL.PLLMUL            = (0x7U << (18U));
  ...
  clkinitstruct.ClockType = (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x00000004) | ((uint32_t)0x00000008));
  clkinitstruct.SYSCLKSource = ((uint32_t)0x00000002);
  clkinitstruct.AHBCLKDivider = ((uint32_t)0x00000000);
  clkinitstruct.APB2CLKDivider = ((uint32_t)0x00000000);
  clkinitstruct.APB1CLKDivider = ((uint32_t)0x00000400);  
  if (HAL_RCC_ClockConfig(&clkinitstruct, (0x2U << (0U)))!= HAL_OK)
  {
