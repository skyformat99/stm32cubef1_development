...
#line 99 "..\\..\\..\\..\\Drivers\\STM32F1xx_HAL_Driver\\Src\\stm32f1xx_hal_iwdg.c"
...
HAL_StatusTypeDef HAL_IWDG_Init(IWDG_HandleTypeDef *hiwdg)
{
  ...
  if(((((hiwdg)->Instance ->SR & (((uint32_t)(0x1U << (0U))))) == (((uint32_t)(0x1U << (0U))))) != RESET)
     &&((((hiwdg)->Instance ->SR & (((uint32_t)(0x1U << (1U))))) == (((uint32_t)(0x1U << (1U))))) != RESET))
  {
    return HAL_ERROR;
  }
  ...
  (((hiwdg)->Instance ->KR) = (((uint32_t)0x5555)));
  
   
  (((hiwdg->Instance ->PR)) = ((((((hiwdg->Instance ->PR))) & (~((0x7U << (0U))))) | (hiwdg->Init . Prescaler))));
  (((hiwdg->Instance ->RLR)) = ((((((hiwdg->Instance ->RLR))) & (~((0xFFFU << (0U))))) | (hiwdg->Init . Reload))));
...
HAL_StatusTypeDef HAL_IWDG_Start(IWDG_HandleTypeDef *hiwdg)
{
  ...
  do{ if((hiwdg)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hiwdg)->Lock = HAL_LOCKED; } }while (0); 
  
       
  hiwdg->State = HAL_IWDG_STATE_BUSY;

   
  (((hiwdg)->Instance ->KR) = (((uint32_t)0xCCCC)));
  
     
  (((hiwdg)->Instance ->KR) = (((uint32_t)0xAAAA)));
  
       
  hiwdg->State = HAL_IWDG_STATE_READY; 
  
   
  do{ (hiwdg)->Lock = HAL_UNLOCKED; }while (0);
...
HAL_StatusTypeDef HAL_IWDG_Refresh(IWDG_HandleTypeDef *hiwdg)
{
  ...
  while((((hiwdg)->Instance ->SR & (((uint32_t)(0x1U << (1U))))) == (((uint32_t)(0x1U << (1U))))) != RESET)
  {
