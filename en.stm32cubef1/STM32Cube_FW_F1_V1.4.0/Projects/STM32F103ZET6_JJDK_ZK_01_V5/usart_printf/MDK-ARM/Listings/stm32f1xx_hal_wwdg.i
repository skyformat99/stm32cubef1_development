...
#line 103 "..\\..\\..\\..\\Drivers\\STM32F1xx_HAL_Driver\\Src\\stm32f1xx_hal_wwdg.c"
...
HAL_StatusTypeDef HAL_WWDG_Init(WWDG_HandleTypeDef *hwwdg)
{
  ...
  (((hwwdg->Instance ->CFR)) = ((((((hwwdg->Instance ->CFR))) & (~(((0x3U << (7U)) | (0x7FU << (0U)))))) | ((hwwdg->Init . Prescaler | hwwdg->Init . Window)))));
 
   
  (((hwwdg->Instance ->CR)) = ((((((hwwdg->Instance ->CR))) & (~((0x7FU << (0U))))) | (hwwdg->Init . Counter))));
...
{ 
  ...
  do{ (hwwdg)->Lock = HAL_UNLOCKED; }while (0);
...
HAL_StatusTypeDef HAL_WWDG_Start(WWDG_HandleTypeDef *hwwdg)
{
  ...
  do{ if((hwwdg)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hwwdg)->Lock = HAL_LOCKED; } }while (0); 
  
     
  hwwdg->State = HAL_WWDG_STATE_BUSY;

   
  (((hwwdg)->Instance ->CR) |= ((0x1U << (7U))));  
...
HAL_StatusTypeDef HAL_WWDG_Refresh(WWDG_HandleTypeDef *hwwdg, uint32_t Counter)
{
  ...
  (((hwwdg->Instance ->CR)) = ((((((hwwdg->Instance ->CR))) & (~((uint32_t)(0x7FU << (0U))))) | (Counter))));
