...
#line 156 "..\\..\\..\\..\\Drivers\\STM32F1xx_HAL_Driver\\Src\\stm32f1xx_hal_rtc.c"
...
HAL_StatusTypeDef HAL_RTC_Init(RTC_HandleTypeDef *hrtc)
{
  ...
  { 
    ...
    ((hrtc->Instance ->CRL) &= ~(((0x1U << (2U)) | (0x1U << (1U)) | (0x1U << (0U)))));
    
    if(hrtc->Init.OutPut != ((uint32_t)0x00000000))
    {
       
      ((((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->CR) &= ~((0x1U << (0U))));
    }
    
     
    (((((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR)) = ((((((((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR))) & (~(((0x1U << (7U)) | (0x1U << (8U)) | (0x1U << (9U)))))) | (hrtc->Init . OutPut))));

    if (hrtc->Init.AsynchPrediv != ((uint32_t)0xFFFFFFFF))
    {
    ...
    else
    {
      ...
      prescaler = HAL_RCCEx_GetPeriphCLKFreq(((uint32_t)0x00000001));
    ...
    (((hrtc->Instance ->PRLH)) = ((((((hrtc->Instance ->PRLH))) & (~((0xFU << (0U))))) | ((prescaler >> 16)))));
    (((hrtc->Instance ->PRLL)) = ((((((hrtc->Instance ->PRLL))) & (~((0xFFFFU << (0U))))) | ((prescaler & (0xFFFFU << (0U)))))));
...
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  if(Format == ((uint32_t)0x000000000))
  {
    ((void)0);
    ((void)0);
    ((void)0);
  ...
  else
  {
    ...
    ((hrtc->Instance ->CRL) &= ~(((0x1U << (0U)) | (0x1U << (2U)))));
...
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  if ((((((hrtc)->Instance ->CRL) & ((0x1U << (2U)))) != RESET)? SET : RESET))
  {
      return HAL_ERROR;
  }
...
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
  ...
  if (HAL_RTC_GetTime(hrtc, &stime, ((uint32_t)0x000000000)) != HAL_OK)
  {
    return HAL_ERROR;
  }
...
HAL_StatusTypeDef HAL_RTC_SetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if(Format == ((uint32_t)0x000000000))
  {
    ...
    counter_alarm = (uint32_t)(((uint32_t)sAlarm->AlarmTime.Hours * 3600) +                         ((uint32_t)sAlarm->AlarmTime.Minutes * 60) +                         ((uint32_t)sAlarm->AlarmTime.Seconds));  
  ...
  else
  {
    ...
    counter_alarm = (((uint32_t)(RTC_Bcd2ToByte(sAlarm->AlarmTime.Hours)) * 3600) +               ((uint32_t)(RTC_Bcd2ToByte(sAlarm->AlarmTime.Minutes)) * 60) +               ((uint32_t)RTC_Bcd2ToByte(sAlarm->AlarmTime.Seconds)));   
...
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  else
  {
    ...
    ((hrtc)->Instance ->CRL) = ~((0x1U << (1U)));
    
     
    (((hrtc)->Instance ->CRH) |= (((0x1U << (1U)))));
    
     
    ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR) |= (((uint32_t)(0x1U << (17U)))));
    
    ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR) |= (((uint32_t)(0x1U << (17U)))));
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{  
  if(((((((hrtc)->Instance ->CRH)& (((0x1U << (1U)))))) != RESET)? SET : RESET))
  {
     
    if((((((hrtc)->Instance ->CRL) & ((0x1U << (1U)))) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
  ...
  (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = (((uint32_t)(0x1U << (17U)))));
...
{  
  ...
  while((((((hrtc)->Instance ->CRL) & ((0x1U << (1U)))) != RESET)? SET : RESET) == RESET)
  {
...
HAL_StatusTypeDef HAL_RTC_WaitForSynchro(RTC_HandleTypeDef* hrtc)
{
  ...
  while((hrtc->Instance->CRL & (0x1U << (3U))) == (uint32_t)RESET)
  {
...
static uint32_t RTC_ReadTimeCounter(RTC_HandleTypeDef* hrtc)
{
  ...
  high1 = ((hrtc->Instance ->CNTH & (0xFFFFU << (0U))));
  low   = ((hrtc->Instance ->CNTL & (0xFFFFU << (0U))));
  high2 = ((hrtc->Instance ->CNTH & (0xFFFFU << (0U))));

  if (high1 != high2)
  { 
 
    timecounter = (((uint32_t) high2 << 16 ) | ((hrtc->Instance ->CNTL & (0xFFFFU << (0U)))));
  }
  else
  { 
...
static HAL_StatusTypeDef RTC_WriteTimeCounter(RTC_HandleTypeDef* hrtc, uint32_t TimeCounter)
{
  ...
  else
  {
    ...
    ((hrtc->Instance ->CNTH) = ((TimeCounter >> 16)));
     
    ((hrtc->Instance ->CNTL) = ((TimeCounter & (0xFFFFU << (0U)))));
...
static uint32_t RTC_ReadAlarmCounter(RTC_HandleTypeDef* hrtc)
{
  ...
  high1 = ((hrtc->Instance ->ALRH & (0xFFFFU << (0U))));
  low   = ((hrtc->Instance ->ALRL & (0xFFFFU << (0U))));
...
static HAL_StatusTypeDef RTC_WriteAlarmCounter(RTC_HandleTypeDef* hrtc, uint32_t AlarmCounter)
{
  ...
  else
  {
    ...
    ((hrtc->Instance ->ALRH) = ((AlarmCounter >> 16)));
     
    ((hrtc->Instance ->ALRL) = ((AlarmCounter & (0xFFFFU << (0U)))));
...
static HAL_StatusTypeDef RTC_EnterInitMode(RTC_HandleTypeDef* hrtc)
{
  ...
  while((hrtc->Instance->CRL & (0x1U << (5U))) == (uint32_t)RESET)
  {
    if((HAL_GetTick() - tickstart) >  1000)
    {       
      return HAL_TIMEOUT;
